...
\solution The ngspice script \texttt{codes/2\_7.cir} simulates the given circuit and the generated plot is as below.
\begin{figure}[!htb]
...
\solution The ngspice script \texttt{codes/3\_5.cir} simulates the given circuit and the generated plot is as below.
\begin{figure}[!htb]
